...
import { ArrowRight, CheckCircle, Code, Zap, Shield, Search, Smartphone, Gauge, ExternalLink } from "lucide-react"
  ...
  const features = [
    {
      ...
      description: "Tailored WordPress themes built from scratch to match your brand identity and business requirements perfectly.",
    },
    {
      icon: Zap,
      title: "Plugin Integration",
      description: "Seamless integration of essential plugins and custom plugin development for specific functionality needs.",
    },
    {
      icon: Gauge,
      title: "Performance Optimization",
      description: "Speed optimization, caching implementation, and database optimization for lightning-fast loading times.",
    },
    {
      icon: Search,
      title: "SEO Ready & Optimized",
      description: "Built-in SEO best practices, schema markup, and optimization for better search engine rankings.",
    },
    {
      icon: Shield,
      title: "Security Hardening",
      description: "Advanced security measures, regular updates, and protection against common WordPress vulnerabilities.",
    },
    {
      icon: Smartphone,
      title: "Mobile Responsive",
      description: "Fully responsive designs that work perfectly across all devices and screen sizes with pixel precision.",
    }
  ]
  ...
  const projects = [
    {
      ...
      description: "WordPress parenting blog with custom theme, advanced SEO, and performance optimization for high organic traffic.",
    ...
    },
    {
      ...
      description: "Specialized WordPress section with custom post types, media gallery, and organized category structure.",
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <motion.p 
                ...
                Transform your business with enterprise-grade WordPress solutions. From stunning custom themes to powerful functionality, 
                I create WordPress websites that drive results and grow with your business.
              </motion.p>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                <h2 className="text-4xl sm:text-5xl font-bold mb-6"
                  ...
                  <span style={{ color: "#0f172a" }}>What You Get with</span>{" "}
                  <span style={{
                    background: "linear-gradient(135deg, #10b981 0%, #06b6d4 100%)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                ...
                <p className="text-lg max-w-3xl mx-auto leading-relaxed"
                  ...
                  Comprehensive WordPress development that covers every aspect of your website needs.
                </p>
              </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                <h2 className="text-4xl sm:text-5xl font-bold mb-6"
                  ...
                  <span style={{ color: "#0f172a" }}>WordPress Development</span>{" "}
                  <span style={{
                    background: "linear-gradient(135deg, #10b981 0%, #06b6d4 100%)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                ...
                <p className="text-lg max-w-3xl mx-auto leading-relaxed"
                  ...
                  Choose the perfect package for your WordPress project. All packages include premium support.
                </p>
              </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                <h2 className="text-4xl sm:text-5xl font-bold mb-6"
                  ...
                  <span style={{ color: "#0f172a" }}>WordPress</span>{" "}
                  <span style={{
                    background: "linear-gradient(135deg, #10b981 0%, #06b6d4 100%)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                ...
                <p className="text-lg max-w-3xl mx-auto leading-relaxed"
                  ...
                  Check out some of my recent WordPress development projects.
                </p>
              </motion.div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <motion.div 
              ...
              <p className="text-lg mb-10 leading-relaxed"
                ...
                Let's discuss your project requirements and create a WordPress solution that exceeds your expectations.
              </p>
