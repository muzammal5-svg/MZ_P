...
const services = [
  {
    ...
    description: "Custom themes, plugin development, and performance optimization for scalable WordPress sites.",
  ...
  },
  {
    ...
    description: "High-converting Shopify stores with custom themes, app integrations, and seamless checkout.",
  ...
  },
  {
    ...
    description: "Modern React and Next.js applications with TypeScript, Tailwind CSS, and responsive design.",
  ...
  },
  {
    ...
    description: "Technical SEO audits, Core Web Vitals improvements, and on-page optimization for organic growth.",
    href: "/services/wordpress",
    icon: (
  ...
  },
  {
    ...
    description: "Professional, mobile-responsive eBay listing templates that build trust and boost conversions.",
  ...
  },
  {
    ...
    description: "Security updates, performance monitoring, backups, and ongoing support for your website.",
    href: "/services/wordpress",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-10 h-10">
...
export function MZwebSolutionsServices() {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6"
            ...
            <span className="text-sm font-medium" style={{ color: "#8b5cf6", fontFamily: "'Poppins', sans-serif" }}>
              What I Do
            </span>
          </div>
            ...
            >
              <Link href={service.href}>
                <motion.div
                  ...
                  className="h-full p-8 rounded-2xl group cursor-pointer"
                  style={{
        ...
        >
          <Link href="/services">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl text-base font-semibold text-white transition-all duration-200"
              style={{
                fontFamily: "'Poppins', sans-serif",
                background: "linear-gradient(135deg, #10b981 0%, #06b6d4 100% 100%)",
